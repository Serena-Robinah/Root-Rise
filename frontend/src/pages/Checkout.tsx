...
export default function Checkout() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl md:text-4xl font-display font-bold mb-6 md:mb-12">Checkout</h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    {...register('fullName')}
                    type="text" 
                    placeholder="yours names please"
  ...
  <p className="font-bold text-sm text-primary-green">UGX {(item.price * item.quantity).toLocaleString()}</p>
            ...
            <div className="pt-6 border-t space-y-4">
              <div className="flex justify-between text-zinc-500">
                <span>Subtotal</span>
                <span className="font-bold text-zinc-800">UGX{getTotal().toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-zinc-500">
                <span>Shipping</span>
              ...
              <div className="pt-4 border-t flex justify-between items-end">
                ...
                <span className="text-2xl md:text-3xl font-bold text-primary-green">UGX{getTotal().toFixed(2)}</span>
              </div>
            </div>
